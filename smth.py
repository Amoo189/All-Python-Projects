...
print('This program can calculate pi number, e number, fabs of  number,floor of  number,ceil of  number,factorial,cos,sin,log of two numbers, pow of two number,sqrt of number,hypot of two numbers,radians,degrees,tan.')
print('____________________________')
...
while True:
    ...
    print('Help:pi for pi,e for e,f for fabs,fl for floor,c for ceil,fa for factorial, cos for cos,sin for sin,l  for log,po for pow, sq for sqrt,hy for hypot,radi for radians, degr for degrees.')
    print('____________________________')
